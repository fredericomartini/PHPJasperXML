	...
	public function add() {
		if ($this->request->is('post')) {
			...
			if ($this->Estado->save($this->request->data)) {
				return $this->flash(__('The estado has been saved.'), array('action' => 'index'));
			}
		}
	}
 ...
 */
	public function delete($id = null) {
		...
		if ($this->Estado->delete()) {
			return $this->flash(__('The estado has been deleted.'), array('action' => 'index'));
		} else {
			return $this->flash(__('The estado could not be deleted. Please, try again.'), array('action' => 'index'));
		}
	}}
